-- Migration: Fix child unit baseprice formula in v_products_admin
-- Change from flat 100k/bag markup to consistent 2000/kg markup
-- Old: (cost + extra) * cv + 100000  (only correct for cv=50)
-- New: (cost + extra + 2000) * cv   (correct for any cv, matches v_products_windmill)
